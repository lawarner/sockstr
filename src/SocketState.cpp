...
// Abstract : Wrapper function for the standard WinSock getsockopt routine
//
...
// Abstract : Wrapper function for the standard WinSock setsockopt routine
//
// Returns  : true if the call was successful, otherwise false
// Params   :
//   pSocket                   Pointer to socket object
...
//
bool
SSOpenedServer::getSockOpt(Socket* pSocket,
                           int  nOptionName, void* pOptionValue,
                           socklen_t* pnOptionLen,  int  nLevel)
{
...
// Abstract : Wrapper function for the setsockopt routine
//
// Returns  : true if the call was successful, otherwise false
// Params   :
//   pSocket                   Pointer to socket object
...
//
bool
SSOpenedServer::setSockOpt(Socket* pSocket,
							   int nOptionName, const void* pOptionValue,
							   int nOptionLen, int nLevel)
{
...
//
bool
SSOpenedClient::getSockOpt(Socket* pSocket,
							   int  nOptionName, void* pOptionValue,
							   socklen_t* pnOptionLen,  int  nLevel)
{
	if (::getsockopt(pSocket->getHandle(), nLevel, nOptionName, (char *)pOptionValue,
...
//
bool
SSOpenedClient::setSockOpt(Socket* pSocket,
							   int nOptionName, const void* pOptionValue,
							   int nOptionLen, int nLevel)
{
	if (::setsockopt(pSocket->getHandle(), nLevel, nOptionName, (char *)pOptionValue,
...
//
bool
SSListening::getSockOpt(Socket* pSocket,
							int  nOptionName, void* pOptionValue,
							socklen_t* pnOptionLen,  int  nLevel)
{
	if (::getsockopt(pSocket->getHandle(), nLevel, nOptionName, (char *)pOptionValue,
...
//
bool
SSListening::setSockOpt(Socket* pSocket,
							int nOptionName, const void* pOptionValue,
							int nOptionLen, int nLevel)
{
	if (::setsockopt(pSocket->getHandle(), nLevel, nOptionName, (char *)pOptionValue,
...
//
bool
SSConnected::getSockOpt(Socket* pSocket,
							int  nOptionName, void* pOptionValue,
							socklen_t* pnOptionLen,  int  nLevel)
{
	if (::getsockopt(pSocket->getHandle(), nLevel, nOptionName, (char *)pOptionValue,
...
//
bool
SSConnected::setSockOpt(Socket* pSocket,
							   int nOptionName, const void* pOptionValue,
							   int nOptionLen, int nLevel)
{
	if (::setsockopt(pSocket->getHandle(), nLevel, nOptionName, (char *)pOptionValue,
